    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">SERVICE PARTS</a>
          </p>
          <p>
            <a href="#!" class="text-reset">WHEELS</a>
          </p>
          <p>
            <a href="#!" class="text-reset">ENGINE</a>
          </p>
          <p>
            <a href="#!" class="text-reset">SUSPENSION</a>
          </p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-phone me-3"></i>+254729429104</p>
          <p><i class="fas fa-print me-3"></i>+254722566585</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2023 Copyright:
    <a class="text-reset fw-bold" href="">Cohort 8</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
