...
Author URI: 
Description: This is a custom plugin that collect contacts information for Mobi-Max.
Version: 1.0
...
class ContactsReg{
    ...
    function create_table_to_db(){
        ...
        $contacts_details = "CREATE TABLE $table_name(
...
if (class_exists('ContactsReg')){
    $contactRegInstance = new ContactsReg();
}
